...
아래는 LeRobot으로 수집된 실제 체스 로봇 데이터셋의 예시입니다. 1500개의 체스 움직임을 학습한 ACT 모델의 데이터를 시각화한 것입니다:

<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; margin: 2rem 0;">
  <iframe 
    src="https://huggingface.co/spaces/lerobot/visualize_dataset/embed?path=%2Fdopaul%2Feval_1500_chess_moves_act_240k%2Fepisode_0" 
    title="LeRobot 체스 데이터셋 시각화"
